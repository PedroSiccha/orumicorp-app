function createDiscount(options) {
    ...
    $.post(saveRetiroRoute, {dniCustomer: 0, amount: amount, observation: observation, percent_id: 0, commission_id: 0, exchange_rate_id: 0, dniAgent: dniAgent, _token: token}).done(function(data) {
        $(table).empty();
